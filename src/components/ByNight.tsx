...
export function ByNight() {
	return (
		<section className="relative overflow-x-clip">
			<div className="clip-angle-y bg-(image:--gradient-surface-radial) pt-17 pb-20 md:mask-torn-y md:py-35.5 md:[clip-path:none]">
				<div className="mx-auto max-w-content px-gutter md:grid md:grid-cols-[235px_1fr] md:items-start md:px-0">
					...
					<div className="mt-10 flex flex-col gap-11.5 md:mt-0">
						<Card
							badge="Study"
							cta="have a look"
